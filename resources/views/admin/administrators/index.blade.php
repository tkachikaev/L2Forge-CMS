...
<div class="admin-overview administrators-toolbar">
    ...
    <p class="admin-overview-copy">{{ __('All administrators have the same access rights.') }}</p>
...
<div class="admin-card-list administrators-list">
    <div class="admin-card-list-header administrator-row administrator-row-header"><span>{{ __('Administrator') }}</span><span>{{ __('Created') }}</span><span>{{ __('Last sign in') }}</span><span>2FA</span><span>{{ __('Status') }}</span><span>{{ __('Actions') }}</span></div>
