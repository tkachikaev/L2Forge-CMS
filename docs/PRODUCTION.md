...
Автоматическая очистка журналов, обработка почтовой очереди в базе данных и другие служебные задачи требуют запуска Laravel Scheduler системой каждую минуту. Развёртывание файлов CMS не создаёт cron и не запускает постоянный worker автоматически: это системная настройка сервера или панели хостинга.
