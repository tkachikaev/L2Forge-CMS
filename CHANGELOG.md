...
- каталог персонажей личного кабинета больше не обращается к внешней GameServer-базе при каждой загрузке и предварительном `wire:navigate.hover` переходе;
- успешный ответ для каждой пары GameServer и игрового аккаунта кешируется на две минуты;
- после ошибки или таймаута повторные обращения к той же паре блокируются на 30 секунд, не затрагивая остальные серверы и аккаунты пользователя.

### Тесты

- добавлены две регрессионные проверки кеширования успешной выборки и защитного cooldown после сбоя внешней базы.
