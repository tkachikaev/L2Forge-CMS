...
return [
    ...
    'connections' => [
        ...
        'mysql' => [
            ...
            'database' => env('DB_DATABASE', 'l2cms'),
        ...
        'game' => [
            ...
            'username' => env('GAME_DB_USERNAME', 'l2cms'),
    ...
    'redis' => [
        ...
        'options' => ['cluster' => env('REDIS_CLUSTER', 'redis'), 'prefix' => env('REDIS_PREFIX', Str::slug(env('APP_NAME', 'l2cms'), '_').'_database_')],
